                                    ...
                                    <div className="row">
                                        {this.state.fetchedHouses.map((house) => {
                                            return <div className="col-sm-4">
                                                <img src={house.photos.length !== 0 && house.photos[0].includes("data") ? house.photos[0] : "data:image;base64, " + house.photos[0]} alt={house.name} className="new-house-small-photo" />
                                            </div>
                                        })}
                                    </div>
